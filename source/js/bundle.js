...
var calculateResultCost = function calculateResultCost() {
  ...
  return "".concat(result.toFixed(), " \u0440\u0443\u0431.");
};
/**
...
var sliderPointAreaHandler = function sliderPointAreaHandler(evt) {
  ...
  var checkBorder = function checkBorder(borderX) {
    if (borderX < -4) {
      sliderPointArea.style.left = "".concat(-4, "px");
      sliderArea.style.width = "".concat(-4, "px");
      repairsAreaInput.value = "".concat(AREA_MIN, " \u043A\u0432. \u043C");
    } else if (borderX > 299) {
      sliderPointArea.style.left = "".concat(299, "px");
      sliderArea.style.width = "".concat(299, "px");
      ...
      repairsAreaInput.value = "".concat(((borderX + 5) * AREA_MAX / 304).toFixed(), " \u043A\u0432. \u043C");
    }
  };
...
var sliderPointBathroomHandler = function sliderPointBathroomHandler(evt) {
  ...
  var checkBorder = function checkBorder(borderX) {
    if (borderX < -4) {
      sliderPointBathroom.style.left = "".concat(-4, "px");
      sliderBathroomArea.style.width = "".concat(-4, "px");
      bathroomAreaInput.value = "".concat(BATHROOM_AREA_MIN, " \u043A\u0432. \u043C");
    } else if (borderX > 299) {
      sliderPointBathroom.style.left = "".concat(299, "px");
      sliderBathroomArea.style.width = "".concat(299, "px");
      ...
      bathroomAreaInput.value = "".concat(((borderX + BATHROOM_AREA_MAX) * BATHROOM_AREA_MAX / 24 / 13).toFixed(), " \u043A\u0432. \u043C");
    }
  };
...
inputDoor.addEventListener('change', function () {
  renderResultCost();
});
